...
/*  Real Charge Divider values */
    ...
    /*  Dividers are not chained */
		...
		const uint8 prescalerTable[CapSense_CSD_PRESCALERS_TBL_SIZE] = {
...
CapSense_CSD_CONFIG_TYPE_P4_v2_10 CapSense_CSD_config;
CapSense_CSD_CONFIG_TYPE_POINTERS_P4_v2_10 const CapSense_CSD_configPointers = {
...
void CapSense_CSD_AutoTune(void)
{
    ...
    CalibrateSensors_P4_v2_10(&CapSense_CSD_config, CapSense_CSD_CAL_RAW_COUNT);
    ...
    TunePrescalers_P4_v2_10(&CapSense_CSD_config);
    ...
    CalibrateSensors_P4_v2_10(&CapSense_CSD_config, CapSense_CSD_CAL_RAW_COUNT);
		...
		CapSense_CSD_NormalizeWidgets(CapSense_CSD_END_OF_WIDGETS_INDEX, CapSense_CSD_modulationIDAC);
	#endif /* (0u != CapSense_CSD_TOTAL_CENTROIDS_COUNT)  */
    TuneSensitivity_P4_v2_10(&CapSense_CSD_config);
...
void CapSense_CSD_UpdateThresholds(uint32 sensor)
{
	...
	widget = CapSense_CSD_widgetNumber[sensor];
		...
		CalculateThresholds_P4_v2_10(&CapSense_CSD_config, (uint8)sensor, CapSense_CSD_sensorRaw, (uint8)widget, CapSense_CSD_fingerThreshold, CapSense_CSD_noiseThreshold);
