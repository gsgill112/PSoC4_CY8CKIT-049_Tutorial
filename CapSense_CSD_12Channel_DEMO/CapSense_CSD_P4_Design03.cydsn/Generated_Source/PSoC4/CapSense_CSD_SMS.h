...
extern uint8 noiseEnvelopeTbl[CapSense_CSD_TOTAL_SENSOR_COUNT];
extern uint8 runningDifferenceTbl[CapSense_CSD_TOTAL_SENSOR_COUNT];
extern uint8 signRegisterTbl[CapSense_CSD_TOTAL_SENSOR_COUNT];
extern uint16 sampleMinTbl[CapSense_CSD_TOTAL_SENSOR_COUNT];
extern uint16 sampleMaxTbl[CapSense_CSD_TOTAL_SENSOR_COUNT];
extern uint16 previousSampleTbl[CapSense_CSD_TOTAL_SENSOR_COUNT];
extern uint8 kValueTbl[CapSense_CSD_TOTAL_SENSOR_COUNT];
