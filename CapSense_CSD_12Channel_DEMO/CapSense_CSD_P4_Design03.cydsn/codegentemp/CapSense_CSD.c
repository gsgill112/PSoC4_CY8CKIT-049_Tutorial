...
reg32 * CapSense_CSD_pcTable[] = {
    ...
    (reg32 *)CapSense_CSD_Sns__LinearSlider0_e5__LS__PC, 
    (reg32 *)CapSense_CSD_Sns__LinearSlider0_e6__LS__PC, 
    (reg32 *)CapSense_CSD_Sns__LinearSlider0_e7__LS__PC, 
    (reg32 *)CapSense_CSD_Sns__LinearSlider0_e8__LS__PC, 
...
const uint8 CapSense_CSD_portTable[] = {
    ...
    CapSense_CSD_Sns__LinearSlider0_e5__LS__PORT, 
    CapSense_CSD_Sns__LinearSlider0_e6__LS__PORT, 
    CapSense_CSD_Sns__LinearSlider0_e7__LS__PORT, 
    CapSense_CSD_Sns__LinearSlider0_e8__LS__PORT, 
...
const uint32 CapSense_CSD_maskTable[] = {
    ...
    CapSense_CSD_Sns__LinearSlider0_e5__LS__MASK, 
    CapSense_CSD_Sns__LinearSlider0_e6__LS__MASK, 
    CapSense_CSD_Sns__LinearSlider0_e7__LS__MASK, 
    CapSense_CSD_Sns__LinearSlider0_e8__LS__MASK, 
...
const uint8 CapSense_CSD_pinShiftTbl[] = {
    ...
    (uint8) CapSense_CSD_Sns__LinearSlider0_e5__LS__SHIFT, 
    (uint8) CapSense_CSD_Sns__LinearSlider0_e6__LS__SHIFT, 
    (uint8) CapSense_CSD_Sns__LinearSlider0_e7__LS__SHIFT, 
    (uint8) CapSense_CSD_Sns__LinearSlider0_e8__LS__SHIFT, 
